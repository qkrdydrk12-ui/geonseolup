...
// 블로그/현장소식/노가다툰 관리자 목록 위에서 공통으로 쓰는 요약 스탯 바.
// 스크롤 없이 전체 조회수·좋아요·저조한 글 개수를 한눈에 보여준다.
export default function AdminStatsSummaryBar({ stats }: { stats: StatsSummary }) {
  ...
  return (
    <div className="flex flex-wrap gap-2 mb-4">
      <div className="flex-1 min-w-[90px] bg-gray-50 border border-gray-100 rounded-lg px-3 py-2">
        <p className="text-[10px] text-gray-400 font-semibold">총 글</p>
