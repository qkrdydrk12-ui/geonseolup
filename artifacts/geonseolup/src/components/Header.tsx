...
export default function Header() {
  ...
  const siteSubtitle =
    localStorage.getItem("cj_site_subtitle") || "건설 현장 일자리 정보";
  ...
  async function handleShare() {
    ...
    const desc =
      localStorage.getItem("cj_footer_text") ||
      "배관·용접·조공·화기감시자 등 전국 건설 현장 구인 공고";
    ...
    <>
      ...
      >
        <div className="max-w-[1100px] mx-auto px-3 py-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          ...
          <Link
            href="/"
            className="flex items-center gap-[7px] no-underline text-white shrink-0"
          >
            <div
            ...
            <div className="relative" data-openchat-menu>
              ...
              >
                ...
                <span className="whitespace-nowrap flex items-center gap-0.5">
                  무료알림톡<span className="text-[8px] opacity-70">▼</span>
                </span>
              </button>
              {menuOpen && (
                <div
